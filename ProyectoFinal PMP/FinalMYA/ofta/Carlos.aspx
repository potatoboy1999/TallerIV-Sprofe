<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Carlos.aspx.cs" Inherits="acordeon.oftalmologia.Carlos" %>
...
<head runat="server">
    ...
    &nbsp;<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script><script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script><style type="text/css">
                                                                                                                                                                                                                                                                                                     .auto-style1 {
                                                                                                                                                                                                                                                                                                         height: 285px;
                                                                                                                                                                                                                                                                                                     }
        ...
        <div id="fotoMedico" class="auto-style1">
            <br />
            <br />
            <img src="../FotosDoctores/DocH.png" />
        </div>
        <asp:Button ID="Button1" CssClass="buttonatras" runat="server" Text="<" OnClick="Button1_Click" />
        <div id="infoMedico">
            <h2 style="text-align: center; color: #2471A3;">Carlos Alonso</h2>
            <div id="infoMedico2">
                <h4>Especialidad:</h4>
                <p>Oftalmologa</p>
                <h4>Sexo:</h4>

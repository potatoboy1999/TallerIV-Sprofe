<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gabriel.aspx.cs" Inherits="acordeon.oftalmologia.Gabriel" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="infoMedico">
            <h2 style="text-align: center; color: #2471A3;">Gabriel Ruiz</h2>
            <div id="infoMedico2">
                <h4>Especialidad:</h4>
                <p>Oftalmologa</p>
                <h4>Sexo:</h4>

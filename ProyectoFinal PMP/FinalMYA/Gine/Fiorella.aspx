<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fiorella.aspx.cs" Inherits="acordeon.Ginecologia.Fiorella" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="infoMedico">
            <h2 style="text-align: center; color: #2471A3;">Fiorella Florez</h2>
            <div id="infoMedico2">
                <h4>Especialidad:</h4>
                <p>Ginecologa</p>
                <h4>Sexo:</h4>

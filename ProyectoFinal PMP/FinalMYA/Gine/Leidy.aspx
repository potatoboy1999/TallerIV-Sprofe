<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Leidy.aspx.cs" Inherits="acordeon.Ginecologia.Leidy" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="infoMedico">
            <h2 style="text-align: center; color: #2471A3;">Leidy Bazques</h2>
            <div id="infoMedico2">
                <h4>Especialidad:</h4>
                <p>Ginecologa</p>
                <h4>Sexo:</h4>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Melanie.aspx.cs" Inherits="acordeon.Doctores.Melanie" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="infoMedico">
            <h2 style="text-align: center; color: #2471A3;">Melanie Estrada</h2>
            <div id="infoMedico2">
                <h4>Especialidad:</h4>
                <p>Odontologia</p>
                <h4>Sexo:</h4>

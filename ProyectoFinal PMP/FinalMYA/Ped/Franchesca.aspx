<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Franchesca.aspx.cs" Inherits="acordeon.Pediatria.Franchesca" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div id="infoMedico">
                <h2 style="text-align: center; color: #2471A3;">Franchesca Garcia</h2>
                <div id="infoMedico2">
                    <h4>Especialidad:</h4>
                    <p>Pediatra</p>
                    <h4>Sexo:</h4>

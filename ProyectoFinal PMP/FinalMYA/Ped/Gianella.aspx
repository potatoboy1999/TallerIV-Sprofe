<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gianella.aspx.cs" Inherits="acordeon.Pediatria.Gianella" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div>
                ...
                <div id="infoMedico">
                    <h2 style="text-align: center; color: #2471A3;">Gianella Braga</h2>
                    <div>
                        <h4>Especialidad:</h4>
                        <p>Pediatra</p>
                        <h4>Sexo:</h4>

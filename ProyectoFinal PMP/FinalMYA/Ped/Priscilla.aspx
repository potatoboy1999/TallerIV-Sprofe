<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Priscilla.aspx.cs" Inherits="acordeon.Pediatria.Priscilla" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div id="infoMedico">
                <h2 style="text-align: center; color: #2471A3;">Priscilla Sanchez</h2>
                <div id="infoMedico2">
                    <h4>Especialidad:</h4>
                    <p>Pediatra</p>
                    <h4>Sexo:</h4>
